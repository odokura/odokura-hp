...
条件付きKYCと属性共有は[属性開示・条件付き本人確認](../foundation/identity-disclosure.md)を正本とする。
...
- 無料取得、待機、一次購入、二次購入、継続支援、出品にKYCを要求しない。
...
| 場面 | ルール |
| --- | --- |
| 購入資格 | 最小限のアカウント、有効な決済手段、同じクリエイター・同じランクの証票を保有していないことだけを確認する。KYC、法的氏名、住所の登録を購入条件にしない |
